...
const translations = {
  fr: {
    ...
    'hero.association.description1': ', Junior de 42 Paris, est une association étudiante qui offre des services technologiques innovants aux entreprises et organisations grâce à une équipe de plus de ',
    ...
    'structure.junior_entreprises.title1': 'Découvrez le mouvement des',
    ...
    'je.cnje.visit_website': 'Visiter le site de la CNJE',
  ...
  en: {
    ...
    'hero.association.description1': ', Junior of 42 Paris, is a student association that offers innovative technological services to companies and organizations thanks to a team of more than ',
    ...
    'structure.junior_entreprises.title1': 'Discover the movement of',
    'structure.junior_entreprises.title2': 'Junior-Entreprises',
