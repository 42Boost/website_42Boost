...
const translations = {
  fr: {
    ...
    'hero.instructor.description': 'Rejoignez notre équipe d\'experts, développez vos compétences et soyez rémunérés en travaillant sur des projets concrets et stimulants.',
    'hero.instructor.cta': 'Devenir intervenant',
    'hero.client': 'Client',
    'hero.client.description': 'Confiez-nous vos projets digitaux et bénéficiez de l\'expertise de nos étudiants-entrepreneurs pour transformer vos idées.',
    ...
    'process.cta.services': 'Voir nos services',
    ...
    'je.what_is.description2': 'Leur mission est double : permettre aux étudiants d\'acquérir une expérience professionnelle concrète tout en proposant des services de qualité aux entreprises à des tarifs avantageux.',
    ...
    'je.cta': 'Découvrir notre structure',
    ...
    'legal.editor.director_value': 'Équipe 42 Boost',
    'legal.hosting.title': 'Hébergeur',
    'legal.hosting.description': 'Ce site est hébergé par un service d\'hébergement web professionnel. Les informations détaillées sur l\'hébergeur sont disponibles sur demande à l\'adresse :',
    ...
    'legal.liability.description2': 'En conséquence, l\'utilisateur reconnaît utiliser ces informations sous sa responsabilité exclusive. 42 Boost ne pourra être tenu responsable d\'éventuels dommages directs ou indirects résultant de l\'utilisation du site web.',
  ...
  en: {
    ...
    'hero.instructor.description': 'Join our team of experts, develop your skills and get paid while working on concrete and stimulating projects.',
    'hero.instructor.cta': 'Become an instructor',
    'hero.client': 'Client',
    'hero.client.description': 'Entrust us with your digital projects and benefit from the expertise of our student-entrepreneurs to transform your ideas.',
    ...
    'je.what_is.description2': 'Their mission is twofold: to allow students to gain concrete professional experience while offering quality services to companies at competitive rates.',
    ...
    'legal.editor.director_value': '42 Boost Team',
    'legal.hosting.title': 'Hosting',
    'legal.hosting.description': 'This website is hosted by a professional web hosting service. Detailed information about the host is available upon request at:',
    ...
    'legal.liability.description2': 'Consequently, the user acknowledges using this information under their exclusive responsibility. 42 Boost cannot be held responsible for any direct or indirect damage resulting from the use of the website.',
    'legal.contact.title': 'Contact',
